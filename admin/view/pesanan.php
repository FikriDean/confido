            ...
            <div class="col-md-12">
              ...
              <div class="card card-warning">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-2 align-items-start mb-2">
                      <button type="button" class="btn btn-primary">Check Tickets Price</button>
                    </div>
                    <div class="col-sm-10">
                      <table class="table">
                        <thead>
                        ...
                        <tbody>
                          <tr>
                            <th scope="row" class="text-primary">Batik Air</th>
                            <td>Rp 1.000.000,00</td>
                          </tr>
                          <tr>
                            <th scope="row" class="text-primary">Lion Air</th>
                            <td>Rp 2.000.000,00</td>
                          </tr>
                          <tr>
                            <th scope="row" class="text-primary">Sriwijaya Air</th>
                            <td>Rp 1.000.000,00</td>
                          </tr>
                        </tbody>
                      </table>
                      <!-- <ul>
                        <li>
                          Batik Air - Rp 1.400.000,00
                        </li>
                        <li>
                          Lion Air - Rp 2.000.000,00
                        </li>
                        <li>
                          Garuda Indonesia - Rp 3.000.000,00
                        </li>
                        <li>
                          Sriwijaya Air - Rp 1.500.000,00
                        </li>
                      </ul> -->
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" id="pergi-check" type="radio" name="radio3" checked>
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" id="pergi-pulang-check" type="radio" name="radio3">
                    ...
                    <div class="col-sm-2">
                      <select class="form-control" id="jumlah-penumpang">
