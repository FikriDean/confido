        ...
        <form class="needs-validation mb-4" action="/orders" method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-12 d-flex flex-column">
              ...
              <input type="number" id="amount" name="amount" step="1" min="1" max="5">
            </div>
          ...
          <div class="row gy-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="name_account" id="name_account" placeholder="" required>
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="from_account" id="from_account" placeholder="" required>
              <div class="invalid-feedback">
...
<script>
  ...
  function init() {
    ...
    checkPriceButton.addEventListener('click', function() {
      fetch(`/checkprice?airline_id=${airline.value}&type_id=${airline_class.value}&from_route=${pickup.value}&to_route=${destination.value}`)
        .then(response => {
        ...
        .then(res => {
          ...
          test.innerHTML = "Price Cannot be displayed";
        });
    })
  }
